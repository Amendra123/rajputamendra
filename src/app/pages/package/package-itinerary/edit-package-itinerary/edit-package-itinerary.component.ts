...
@Component({
  selector: 'app-edit-package-itinerary',
  templateUrl: './edit-package-itinerary.component.html',
  styleUrls: ['./edit-package-itinerary.component.scss'],
  providers: [PackageUtilityService]
})

export class EditPackageItineraryComponent {
  ...
  createPackageForm(data: any,pack:any) {
console.log(pack);
    return this._formBuilder.group({
      from_city: [data.from_city, [Validators.required]],
     // package_city: [pack, [Validators.required]],
  ...
  editQuantity1(data:any): FormGroup {  
    return this._formBuilder.group({  
      events: '' || data.event1,
  ...
  editQuantity2(data:any): FormGroup {  
    return this._formBuilder.group({  
      events: '' || data.event2,
      activity: '' || data.activity2
    })  
  } 
  editQuantity3(data:any): FormGroup {  
    return this._formBuilder.group({  
      events: '' || data.event3,
      activity: '' || data.activity3
    })  
  } 
  editQuantity4(data:any): FormGroup {  
    return this._formBuilder.group({  
      events: '' || data.event4,
      activity: '' || data.activity4
    })  
  } 
  editQuantity5(data:any): FormGroup {  
    return this._formBuilder.group({  
      events: '' || data.event5,
      activity: '' || data.activity5
    })  
  } 
  editQuantity6(data:any): FormGroup {  
    return this._formBuilder.group({  
      events: '' || data.event6,
      activity: '' || data.activity6
    })  
  } 
  editQuantity7(data:any): FormGroup {  
    return this._formBuilder.group({  
      events: '' || data.event7,
      activity: '' || data.activity7
    })  
  } 
  editQuantity8(data:any): FormGroup {  
    return this._formBuilder.group({  
      events: '' || data.event8,
      activity: '' || data.activity8
    })  
  } 
  editQuantity9(data:any): FormGroup {  
    return this._formBuilder.group({  
      events: '' || data.event9,
      activity: '' || data.activity9
    })  
  } 
  editQuantity10(data:any): FormGroup {  
    return this._formBuilder.group({  
      events: '' || data.event10,
      activity: '' || data.activity10
    })  
  } 
  ...
  async ngOnInit() {
   ...
   // this.createPackage.addControl('slider1',[]);
    ...
    this.createPackage = this._formBuilder.group({
      from_city: [data.from_city, [Validators.required]],
     // package_city: [data.packcity, [Validators.required]],
      title: [data.title, [Validators.required]],      
      events: this._formBuilder.array([]),
      activity: this._formBuilder.array([]),
   ...
   await id && this.rootService.getPackageIteneray(id).subscribe(async (res: any) => {
      this.data = res['response'];
      if (res.status == 200) {
        await  this.rootService.getPackageCityByIdAllData(res['response'][0].p_city,1).subscribe((res1:any)=>{
           this.packcity= res1['response'][0]['city_name'];
          console.log(this.packcity);
          this.data[0].packcity=this.packcity;
          
      });
      console.log(this.data);
      this.createPackage = this._formBuilder.group({
        from_city: [this.data.from_city, [Validators.required]],
      //  package_city: [this.data.packcity, [Validators.required]],
        title: [this.data.title, [Validators.required]],      
        events: this._formBuilder.array([]),
        activity: this._formBuilder.array([]),
  
      });
      var city :any= this.getPackCity(res['response'][0].p_city,1);
      //console.log(city);
     
       this.createPackage = this.createPackageForm(res['response'][0],this.data.packcity);
        console.log(this.data.packcity);
       // this.getSubCat(res['response'].package);
       if(res['response'][0]['event1']!="" && res['response'][0]['event1']!=null){
        this.events().push(this.editQuantity1(res['response'][0]));
       }
       if(res['response'][0]['event2']!=""  && res['response'][0]['event2']!=null){
        this.events().push(this.editQuantity2(res['response'][0]));
       }
       if(res['response'][0]['event3']!=""  && res['response'][0]['event3']!=null){
        this.events().push(this.editQuantity3(res['response'][0]));
       }
       if(res['response'][0]['event4']!=""  && res['response'][0]['event4']!=null){
        this.events().push(this.editQuantity4(res['response'][0]));
       }
       if(res['response'][0]['event5']!=""  && res['response'][0]['event5']!=null){
        this.events().push(this.editQuantity5(res['response'][0]));
       }
       if(res['response'][0]['event6']!=""  && res['response'][0]['event6']!=null){
        this.events().push(this.editQuantity6(res['response'][0]));
       }
       if(res['response'][0]['event7']!=""  && res['response'][0]['event7']!=null){
        this.events().push(this.editQuantity7(res['response'][0]));
       }
       if(res['response'][0]['event8']!=""  && res['response'][0]['event8']!=null){
        this.events().push(this.editQuantity8(res['response'][0]));
       }
       if(res['response'][0]['event9']!=""  && res['response'][0]['event9']!=null){
        this.events().push(this.editQuantity9(res['response'][0]));
       }
       if(res['response'][0]['event10']!=""  && res['response'][0]['event10']!=null){
        this.events().push(this.editQuantity10(res['response'][0]));
       }
 ...
 getPackCity(id:any,limit:any){
  return this.rootService.getPackageCityByIdAllData(id,limit).subscribe((res:any)=>{
      res['response'][0];
  })
 }
  selectFile(event: any,i:any): void {
    const file: File = event.target.files[0];
    if(i==0){
  ...
  addPackage() {
   ...
   console.log(this.data);
    formData.append('p_city', this.data[0].p_city);
    ...
    const id = (this.route.url).split('/')[3]; 
    id && this._packService.updatePackageIteneray(formData,id).subscribe((res: any) => {
