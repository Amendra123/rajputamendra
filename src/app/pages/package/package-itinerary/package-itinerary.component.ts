...
export class PackageItineraryComponent {
  limit: number=100000;
    name: string='';
    tags: any;
    public p: any = 1
  ...
  getPackageItenerayData(){
    this.rootService.getPackageItenerayData(this.name,this.limit).subscribe((res:any)=>{
