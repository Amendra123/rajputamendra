...
@Component({
  ...
  styleUrls: ['./package-detail-list.component.scss']
})

export class PackageDetailListComponent {
  limit: number=100000;
    name: string='';
    tags: any;
    public p: any = 1
  ...
  getPackageListData(){
    const id=(this.route.url).split('/')[3];
    this.rootService.getPackageListData(id,this.name,this.limit).subscribe((res:any)=>{
